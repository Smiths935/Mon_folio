  ...
  const categories = {
    frontend: {
      ...
      skills: [
        ...
        { name: 'TypeScript', logo: ReactIco, color: 'from-blue-600 to-cyan-500' },
        { name: 'Next.js', logo: Nextjs, color: 'from-gray-800 to-gray-900 dark:from-gray-200 dark:to-gray-300' },
        { name: 'Tailwind CSS', logo: TailWindIco, color: 'from-cyan-400 to-teal-500' },
        { name: 'Framer Motion', logo: ReactIco, color: 'from-purple-500 to-pink-500' },
      ],
    },
    backend: {
      name: 'Backend',
      ...
      skills: [
        { name: 'Node.js', logo: ReactIco, color: 'from-green-500 to-green-600' },
        { name: 'Express', logo: Express, color: 'from-gray-600 to-gray-700 dark:from-gray-300 dark:to-gray-400' },
        { name: 'Python', logo: ReactIco, color: 'from-yellow-400 to-blue-500' },
        { name: 'Django', logo: Django, color: 'from-green-600 to-green-700' },
        { name: 'GraphQL', logo: ReactIco, color: 'from-pink-500 to-purple-600' },
      ],
    },
    devops: {
      name: 'DevOps & Cloud',
      ...
      skills: [
        ...
        { name: 'Kubernetes', logo: ReactIco, color: 'from-blue-600 to-blue-700' },
        { name: 'AWS', logo: Aws, color: 'from-orange-500 to-yellow-500' },
        { name: 'GitHub Actions', logo: ReactIco, color: 'from-gray-800 to-gray-900 dark:from-gray-200 dark:to-gray-300' },
        { name: 'Terraform', logo: ReactIco, color: 'from-purple-600 to-purple-700' },
      ],
    },
    databases: {
      ...
      skills: [
        { name: 'PostgreSQL', logo: ReactIco, color: 'from-blue-600 to-indigo-600' },
        { name: 'MongoDB', logo: ReactIco, color: 'from-green-500 to-green-600' },
