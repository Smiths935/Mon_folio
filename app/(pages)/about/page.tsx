            ...
            {[
              {
                ...
                labelF: "3+ ans d'expérience",
                label:"3+ years of experience"
              },
              { icon: <Globe className="w-6 h-6" />, labelF: "15+ projets", label:"15+ projects" },
              { icon: <Users className="w-6 h-6" />, labelF: "10+ clients", label:"10+ clients" },
            ].map((item, index) => (
              <div
                key={index}
