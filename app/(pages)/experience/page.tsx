  ...
  const experiences = [
    {
      ...
      description:
        language === "en"
          ? `Collector and organizer of large volumes of data, while
facilitating their acquisition and circulation, in compliance with
the rules of compliance. 
 Structuring this data to make it usable and relevant.
 Participating in the implementation of the technical infrastructure
necessary for collection.
 Setting up and managing access to structured data for
easier use for all professions.
`
          : `Collecteur et organisateur de grands volumes de données, tout en 
...
une utilisation facilitée pour l'ensemble des métiers.`,
    ...
    {
      title:
        language === "en" ? "IT Support Specialist" : "Technicien informatique",
      ...
      description:
        language === "en"
          ? `Increase the speed of resolving technical issues by 40% by introducing a new management system.
 Manage the company's client database.
 Gather data, organize and keep a log of issues and solutions to be used by other colleagues.
 Assist management in developing current marketing, business and digital/media off and on-line strategy.
 Install, test and update computer equipment (computers, software).`
          : `Augmenter la vitesse de résolution des problèmes techniques de
...
(ordinateurs, logiciels).`,
    },
    {
      ...
      description:
        language === "en"
          ? `Support programmers by identifying improvement opportunities and
developing new features and web development.
 Support, develop and optimize SQL queries.
 Assist in application investigations (debugging).
 Support various projects, initiatives and tasks.
 Participate, where appropriate, in the architecture and design of websites
 in collaboration with designers or clients`
          : `Appuyez les programmeurs en identifiant des opportunités 
    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          {
            language === "en"
              ? `Here's my journey as a software engineer — from complex projects, modern stacks, and continuous growth.`
